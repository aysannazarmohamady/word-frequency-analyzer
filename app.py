...
def get_stopwords():
    ...
    persian_stopwords = {
        ...
        'جلو', 'عقب', 'بالا', 'پایین', 'داخل', 'خارج', 'میان', 'بین', 'علیه', 'ضد', 'مانند', 'همچون',
        ...
        # کلمات عمومی غیرمفید
        'چیز', 'چیزی', 'جای', 'جایی', 'وقت', 'زمان', 'بار', 'دفعه', 'مرتبه', 'نوع', 'قسم', 'گونه',
        'راه', 'روش', 'شکل', 'حالت', 'صورت', 'طور', 'جور', 'نحو', 'سان', 'گاه', 'وقتی', 'زمانی',
        'بعد', 'قبل', 'پیش', 'حال', 'حالا', 'الان', 'اکنون', 'امروز', 'دیروز', 'فردا', 'امشب',
        'صبح', 'ظهر', 'عصر', 'شب', 'شام', 'بامداد', 'سپیده', 'طلوع', 'غروب', 'نیمه‌شب', 'ظهر',
        ...
        'اول', 'دوم', 'سوم', 'چهارم', 'پنجم', 'ششم', 'هفتم', 'هشتم', 'نهم', 'دهم', 'آخر', 'اخیر',
        'نخست', 'نخستین', 'آخرین', 'اخیرین', 'بعدی', 'قبلی', 'پیشین', 'گذشته', 'آینده', 'جاری',
        
        # کلمات منفی
        'نه', 'نا', 'غیر', 'بی', 'ضد', 'خلاف', 'برعکس', 'بالعکس', 'مخالف', 'موافق', 'طرفدار',
